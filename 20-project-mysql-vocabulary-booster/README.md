...
1. Abra os arquivos hr.sql e w3schools com algum editor de texto, e selecione todo o conteúdo dos arquivos usando `CTRL-A`.

2. Abra o MySQL Workbench.

3. Abra uma nova janela de query e cole dentro dela todo o conteúdo do arquivo `hr` e rode a query no botão com o símbolo do trovão.

4. Abra uma nova janela de query e cole dentro dela todo o conteúdo do arquivo `w3schools.sql` e rode a query no botão com o símbolo do trovão.
